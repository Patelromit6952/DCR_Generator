...
import { saveQuotationToDB } from '../services/quotationService';
...
import { generateAbstractPDFTemplate, createPDFWindow, writeToPDFWindow, generateMeasurementPDFTemplate } from '../utils/pdfTemplates';
...
// Function to transform saved quotation data to component format
...
const PaverBlock = () => {
  ...
  // Function to load quotation data from previous page
  ...
  // Save quotation to database function
